...
public class InputFileDataHandler : AppInvocable, IAsyncDataSourceHandler
{
    private readonly string _projectId;
    
    public InputFileDataHandler(InvocationContext invocationContext, [ActionParameter] GetOutputFileRequest projectRequest) : base(invocationContext)
    {
    ...
    public async Task<Dictionary<string, string>> GetDataAsync(DataSourceContext context, CancellationToken cancellationToken)
    {
        ...
        string endpoint = ApiEndpoints.Projects + $"/{_projectId}" + ApiEndpoints.InputFiles;
