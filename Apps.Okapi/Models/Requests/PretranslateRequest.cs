...
public class PretranslateRequest
{
    ...
    [Display("TM path on OKAPI server to TMX file or Pensieve TM folder)", Description = "Path to TM local to OKAPI server, use \"Upload translation assets\" action to obtain this path.")]
